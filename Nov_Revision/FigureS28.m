...
p1=plot(t-ts,S1,'color',hex2rgb('#2A3132'),'LineWidth',2); hold on
...
text(-3.28,0.969543147208122,'A','Fontsize',32,'FontWeight','bold');
...
tL=1.9;
S1=SensitivityvsViralLoad(ViralShedding_Symptomatic(t,tL),ts,tL);
p2=plot(t-ts,S1,'color',hex2rgb('#66A5AD'),'LineWidth',2); hold on

tL=3.9;
S1=SensitivityvsViralLoad(ViralShedding_Symptomatic(t,tL),ts,tL);
p3=plot(t-ts,S1,'color',hex2rgb('#4CB5F5'),'LineWidth',2); hold on
...
text(-11.82,0.969543147208122,'B','Fontsize',32,'FontWeight','bold');
