...
if(ii==2)
    ...
    % xtickangle(45);
    ylim([0 0.035]);
    text(1.25,0.035,['April 11 ' char(8722) ' June 24'],'Fontsize',18,'HorizontalAlignment','center');
    text(3,0.035,['June 25 ' char(8722) ' August 26'],'Fontsize',18,'HorizontalAlignment','center');
    ...
    % xtickangle(45);
    ylim([0 0.035]);    
    text(1,0.035,['April 11 ' char(8722) ' August 12'],'Fontsize',18,'HorizontalAlignment','center');
    text(2.25,0.035,['August 13 ' char(8722) ' August 26'],'Fontsize',18,'HorizontalAlignment','center');
    ylabel('Positivity rate (%)','Fontsize',18);
...
if(ii==2)
    text(0.9525,-0.005230149597238,'+','Fontsize',16);
    text(1.488435563816605,-0.005230149597238,'+','Fontsize',16);
    text(2.4469,-0.005230149597238,'+','Fontsize',16);
    text(3.002066294919456,-0.005230149597238,'+','Fontsize',16);
    text(3.5572,-0.005230149597238,'+','Fontsize',16);
else
    text(0.965625,-0.005230149597238,'+','Fontsize',16);
    text(1.9817,-0.005230149597238,'+','Fontsize',16);
    text(2.5052,-0.005230149597238,'+','Fontsize',16);
end
