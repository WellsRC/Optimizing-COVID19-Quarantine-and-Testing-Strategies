...
for jj=1:4221
        ...
        R(jj)=dblquad(@(u,t)(DurationInfected(u,IncubationI(jj),tsv(jj)).*InfectiousnessfromInfectionTestingEntry(t+u,u+q(jj)-1,R0S,R0A,pA,tsv(jj),SelfIsolate)),0,tsv(jj),q(jj),inf);       
        RD1(jj)=dblquad(@(u,t)(DurationInfected(u,IncubationI(jj),tsv(jj)).*InfectiousnessfromInfectionTestingEntry(t+u,u+d1+q(jj)-1,R0S,R0A,pA,tsv(jj),SelfIsolate)),0,tsv(jj),q(jj)+d1,inf);
        
        % Computation for asymptomatic that infected the index case
        % ONLY ASYMPTOMATIC (SET SELF-ISOLATION TO ZER0 TO ENSURE)
        RA(jj)=(1./quadv(@(u)(InfectiousnessfromInfection(u,R0,R0,1,tsv(jj),0)),tsv(jj),inf)).*dblquad(@(u,t)(InfectiousnessfromInfection(u,R0S,R0A,1,tsv(jj),0).*InfectiousnessfromInfectionTestingEntry(t+u,u+q(jj)-1,R0S,R0A,1,tsv(jj),0)),0,td(jj),tsv(jj)+q(jj),inf);       
        RAD1(jj)=(1./quadv(@(u)(InfectiousnessfromInfection(u,R0,R0,1,tsv(jj),0)),tsv(jj)+d1,inf)).*dblquad(@(u,t)(InfectiousnessfromInfection(u,R0S,R0A,1,tsv(jj),0).*InfectiousnessfromInfectionTestingEntry(t+u,u+d1+q(jj)-1,R0S,R0A,1,tsv(jj),0)),0,td(jj),tsv(jj)+q(jj)+d1,inf);       
end
