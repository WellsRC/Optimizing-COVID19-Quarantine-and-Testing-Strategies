...
for jj=1:4422
        ...
        RA(jj)=(1./quadv(@(u)(InfectiousnessfromInfection(u,R0,R0,1,tsv(jj),0)),tsv(jj),inf)).*dblquad(@(u,t)(InfectiousnessfromInfection(u,R0S,R0A,1,tsv(jj),0).*InfectiousnessfromInfectionTestingEntry(t+u,u+q(jj),R0S,R0A,1,tsv(jj),0)),0,td(jj),q(jj),inf);       
        RAD1(jj)=(1./quadv(@(u)(InfectiousnessfromInfection(u,R0,R0,1,tsv(jj),0)),tsv(jj),inf)).*dblquad(@(u,t)(InfectiousnessfromInfection(u,R0S,R0A,1,tsv(jj),0).*InfectiousnessfromInfectionTestingEntry(t+u,u+d1+q(jj),R0S,R0A,1,tsv(jj),0)),0,td(jj),q(jj)+d1,inf);       
end
