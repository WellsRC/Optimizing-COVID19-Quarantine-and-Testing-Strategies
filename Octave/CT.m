...
for jj=1:4422
        ...
        R(jj)=dblquad(@(u,t)(DurationInfected(u,IncubationI(jj),tsv(jj)).*InfectiousnessfromInfection(t+u,R0S,R0A,pA,tsv(jj),SelfIsolate)),0,tsv(jj),(q(jj)),inf);       
        RD1(jj)=dblquad(@(u,t)(DurationInfected(u,IncubationI(jj),tsv(jj)).*InfectiousnessfromInfection(t+u,R0S,R0A,pA,tsv(jj),SelfIsolate)),0,tsv(jj),(q(jj)+d1),inf); 
