...
t=linspace(0,30,101);
%need to flip based on how the coefifciented were estimated and how polyval
%works
plot(t,1./(1+exp(-polyval(flip([beta{dAIC==0}]),t))),'k',t,1./(1+exp(-polyval(flip([beta{2}]),t))),'r')
hold on
scatter(xt,y,20,'b');