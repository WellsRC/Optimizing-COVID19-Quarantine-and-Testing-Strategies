...
for jj=1:201
        ...
        IDSL(jj)=(1-pA).*((1./tsv(jj)).*dblquad(@(u,t)InfectiousnessfromInfectionTestingEntryExit(t+u,u,u+4,R0S,R0A,0,tsv(jj),SelfIsolate),0,tsv(jj),q(jj),inf))+pA.*((1./td(jj)).*dblquad(@(u,t)InfectiousnessfromInfectionTestingEntryExit(t+u,u,u+4,R0S,R0A,1,tsv(jj),0),0,td(jj),q(jj),inf));  
end
